  ...
  return (
    <div className="card-elevated rounded-2xl p-4 max-w-[520px] mx-auto">
      <div className="flex items-center gap-3 mb-3">
        <div className="h-10 w-10 rounded-full glass-accent flex items-center justify-center">
          <span className="text-body font-bold text-white">A</span>
        </div>
        <div>
      ...
      <div className="aspect-video rounded-xl card-elevated atmospheric-glow mb-3" />
      <div className="flex items-center justify-between text-muted-foreground pt-2 border-t border-white/[0.08]">
  ...
  return (
    <div className="max-w-[420px] mx-auto">
      <div className="rounded-2xl card-surface p-4">
        <div className="aspect-video rounded-xl card-elevated atmospheric-glow mb-2" />
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/[0.08]">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="rounded-md p-1 text-muted-foreground hover:text-foreground glass-button"
            >
